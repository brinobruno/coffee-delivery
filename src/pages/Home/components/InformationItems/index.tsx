  ...
  return (
    <InformationItems>
      ...
      <InformationItem itemColor={'gray'}>
        <div>
          <Package size={16} weight="fill" color={currentTheme['gray-100']} />
        </div>
      ...
      <InformationItem itemColor={'lighterYellow'}>
        <div>
          <Clock size={16} weight="fill" color={currentTheme['gray-100']} />
        </div>
      ...
      <InformationItem itemColor={'purple'}>
        <div>
          <Coffee size={16} weight="fill" color={currentTheme['gray-100']} />
        </div>
